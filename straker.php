...
/*
Plugin Name: Straker
Plugin URI: http://www.strakertranslations.com/
Description: Adds userfriendly multilingual content support into Wordpress.
Version: 1.0
Author: Straker Software
Author URI: http://www.strakersoftware.com
Tags: multilingual, multi, language, admin, tinymce, straker, Polyglot, bilingual, widget, switcher, professional, human, translation, service
*/
/*
...
// straker Editor will only activated for the given version of Wordpress.
// Can be changed to use with other versions but might cause problems and/or data loss!
define('QT_SUPPORTED_WP_VERSION', '3.0.4');
define('QT_STRING',		1);
define('QT_BOOLEAN',	2);
define('QT_INTEGER',	3);
define('QT_URL',		4);
...
// straker Services
$q_config['straker_services'] = false;
...
$q_config['flag_location'] = 'plugins/straker/flags/';
...
// Load straker
require_once(dirname(__FILE__)."/straker_javascript.php");
require_once(dirname(__FILE__)."/straker_utils.php");
require_once(dirname(__FILE__)."/straker_core.php");
require_once(dirname(__FILE__)."/straker_wphacks.php");
require_once(dirname(__FILE__)."/straker_widget.php");
require_once(dirname(__FILE__)."/straker_configuration.php");

// load straker Services if available
if(file_exists(dirname(__FILE__)."/straker_services.php"))
	require_once(dirname(__FILE__)."/straker_services.php");
	
if(file_exists(dirname(__FILE__)."/straker_translate.php"))
	require_once(dirname(__FILE__)."/straker_translate.php");

// set hooks at the end
require_once(dirname(__FILE__)."/straker_hooks.php");
?>